...
Deep DSLs is a value-level way of extracting an expression, but there are others.
Quasi-quoting is another, at the syntactic level. Haskell comes with an extensive
template system, called Template Haskell, that is used for DSLs.
