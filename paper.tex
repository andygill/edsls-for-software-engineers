...
is an extended version of the Haskell primer given by the author in~\cite{?}.
...
ideas have been used in Java, for a VHDL generator\cite{...}. 
...
including Feldspar\cite{..} and Sunroof\cite{..}.
